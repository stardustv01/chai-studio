...
- The measured support claim is Apple M4 with 16 GB unified memory on arm64 macOS. Other arm64 Macs are compatible-unmeasured only when doctor passes.
- Version 1 is a localhost web/server product for personal use. It has no desktop wrapper, cloud account, collaboration, hosted rendering, marketplace, external publishing, multicam, mobile editing, or nodal compositor.
- Public/commercial distribution, team growth, and automation-scale changes require fresh security and license review. Current release checksums are for personal local distribution, not notarized public packaging.
